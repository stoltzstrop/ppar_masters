...
void writeOutputAudio(float *audio,                 // Pointer to buffer
...
void printLastSamples(float *audio,           // Pointer to buffer
...
// ----------------------------------------------------------------
void printLastSamples(float *audio, int NF, int N) {
...
// ----------------------------------------------------------------
void writeOutputAudio(float *audio, int NF, const char outputFile[]) {
   ...
   if(file_ptr != NULL)
   {
      bytes_written = fwrite(audio,sizeof(float),(size_t)NF,file_ptr);
